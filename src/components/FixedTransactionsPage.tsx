...
export function FixedTransactionsPage() {
  ...
  return (
    <div className="spacing-responsive-md fade-in pb-6 sm:pb-8">
      ...
      <Card className="bg-white/10 border-white/20 dark:bg-primary/5 dark:border-primary/20">
        <CardContent className="p-4">
          <div className="flex gap-3 items-start">
            <CalendarPlus className="h-5 w-5 text-white dark:text-primary mt-0.5 flex-shrink-0" />
            <p className="text-body text-white dark:text-foreground">
