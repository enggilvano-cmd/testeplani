-- Corrigir atomic_update_transaction para incluir invoice_month_overridden
...
COMMENT ON FUNCTION public.atomic_update_transaction IS 'Atualiza transação(ões) garantindo sinal correto do amount e campo invoice_month_overridden, recalcula saldos atomicamente';