-- Drop and recreate atomic_create_transfer function to fix ambiguous success column
...
BEGIN
  ...
  INSERT INTO transactions (
    ...
    p_user_id, p_from_account_id, 'expense', p_amount, p_date, p_description, p_status, p_to_account_id
  ...
  INSERT INTO transactions (
    ...
    p_user_id, p_to_account_id, 'income', p_amount, p_date, p_description, p_status, v_outgoing_id
