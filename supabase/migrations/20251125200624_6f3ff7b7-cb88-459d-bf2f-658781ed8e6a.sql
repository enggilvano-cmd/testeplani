-- Corrigir atomic_create_transfer para considerar limite em todos os tipos de conta
...
BEGIN
  ...
  -- ✅ CORREÇÃO: Validar saldo disponível (balance + limit) para TODOS os tipos de conta
