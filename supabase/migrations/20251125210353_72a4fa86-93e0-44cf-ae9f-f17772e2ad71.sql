-- Corrigir get_transactions_totals para SEMPRE excluir transferências
...
BEGIN
  ...
  -- Calcular totais com filtros aplicados, SEMPRE excluindo transferências
  RETURN QUERY
  SELECT
    COALESCE(SUM(CASE 
  ...
  WHERE t.user_id = p_user_id
    AND t.type != 'transfer' -- CRÍTICO: Sempre excluir transferências
