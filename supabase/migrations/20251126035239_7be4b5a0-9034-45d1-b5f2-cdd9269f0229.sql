-- Atualizar get_transactions_totals para excluir transações fixas parent
...
SEMPRE exclui transações de transferência e transações fixas parent para evitar duplicação de valores.
