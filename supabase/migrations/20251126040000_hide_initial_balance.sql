-- Atualizar get_transactions_totals para excluir transações com descrição 'Saldo Inicial'
...
SEMPRE exclui transações de transferência, transações fixas parent e transações de Saldo Inicial.
