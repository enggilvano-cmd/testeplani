-- Consolidated migration to fix Provision Logic and Sync
...
-- 3. Create the main function for creating fixed transactions (with Provision logic)
...
-- 4. Create the Trigger Function for automatic deduction
