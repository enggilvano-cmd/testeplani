...
-- Atualizar as transferências existentes que foram criadas como 'expense' para 'transfer'
UPDATE transactions 
SET type = 'transfer' 
WHERE type = 'expense' 
...
A transação de saída é criada com tipo "transfer" e a de entrada com tipo "income" + linked_transaction_id.
Corrigido para não contar transferências como despesas nos totais.';
